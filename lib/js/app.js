        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $("#authLink").html(`<img src="${response.user.avatar_url}" alt="${response.user.name}" style="width: 20px; height: 20px; border-radius: 50%; margin-right: 5px;"> ${response.user.name}`);
