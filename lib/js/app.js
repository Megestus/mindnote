// 在文件顶部更新主题列表
const themes = ['theme-dracula', 'theme-nord', 'theme-github-dark'];
...
$(function () {
    ...
    function updateUIForLoggedInUser(user) {
        ...
        $("#userAvatarLink").attr("href", `https://github.com/${user.login}/mindnote-blog`);
    ...
    function generateTOC() {
        if (!editor || typeof editor.getValue !== 'function') {
            console.log("Editor not ready, skipping TOC generation");
            return;
        }
        ...
        toc.forEach(item => {
            ...
            const a = $('<a>').attr('href', '#').html(formatTOCItem(item));
            a.click(function (e) {
                e.preventDefault();
    ...
    function toggleTheme() {
        ...
        // 如果你添加了 light-theme 的样式到 theme.css 中
    }

    // 在适当的地方调用这个函数，比如添加一个主题切换按钮
});
